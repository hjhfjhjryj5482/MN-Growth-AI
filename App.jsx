...
function CustomersSection({ businessId, businessName }) {
  ...
  const [addForm, setAddForm] = useState({ name: "", phone: "", tag: "New" });
    ...
    <div className="mnft min-h-screen w-full flex items-center justify-center p-5" data-mode="dark">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-7 fade-in">
          ...
          <p className="text-xs mb-5" style={{ color: "var(--muted)" }}>Takes 20 seconds. Your feedback goes straight to the team.</p>
...
export default function App() {
  ...
  const visibleNav = NAV.filter((n) => n.key !== "referrals" || referralEnabled);
